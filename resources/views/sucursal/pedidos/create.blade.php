...
@endsection
@section('content')
    {!! Form::open(['route'=>'sucursal.pedidos.forma_pago','id'=>'formulario', 'method'=>'POST']) !!}
    <div class="container">
                        ...
                        <tbody id="pacientes">
                            @foreach($pacientes as $paciente)
                                <tr>
                                    ...
                                    <td><a class="waves-effect waves-light btn tooltipped" data-position="right" data-delay="50" data-tooltip="Selecciona un paciente" id="{{$paciente->id}}" onclick="seleccionar({{$paciente->id}})">Seleccionar</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    {!! Form::close() !!}
    {!! Form::open(['route'=>['sucursal.pedidos.busqueda_pacientes',':DATA'], 'method'=>'GET','id'=>'form']) !!}
    {!! Form::close() !!}
@endsection
@section('scripts')
    @if($errors)
